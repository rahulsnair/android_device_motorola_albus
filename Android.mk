...
FIRMWARE_ZAP_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(FIRMWARE_ZAP_IMAGES)))
...
FIRMWARE_CMNLIB64_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(FIRMWARE_CMNLIB64_IMAGES)))
...
FIRMWARE_CPE_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(FIRMWARE_CPE_IMAGES)))
...
FIRMWARE_JSLR_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(FIRMWARE_JSLR_IMAGES)))
...
FIRMWARE_VENUS_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(FIRMWARE_VENUS_IMAGES)))
